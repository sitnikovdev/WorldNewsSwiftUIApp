...
p.s. На последней сборке обнаружил баг с добавлением статьи в закладки. После добавления иконка статьи остается висеть в списке закладок. Если зайти в приложение снова, закладка появиься. Попробую пофиксить.
